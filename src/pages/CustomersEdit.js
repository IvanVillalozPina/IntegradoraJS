                ...
                <div className='divi2'>
                    <center>
                        <div className="card bg-light mb-3">
                            <div className="card-header"> <h1>Actualización de cliente</h1> </div>
                            <div className="card-body">
                                <div>
                                <form >
                                <div className='colorear'>
                                            ID cliente <br /> <input className='input-group-text' type='text' name='id_canal'
                                            readOnly
                                            />
                                        </div>
                                        <br />
                                        ...
                                        ></input>
                                        <br />
                                        <input className='btn btn-secondary' type='submit' value='Actualizar cliente' />
                                    </form>
                                </div>
                                <br />
                                {/*
